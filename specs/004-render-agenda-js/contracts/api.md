...
- **422** `fuente_ilegible`: URL ilegible, destino bloqueado por SSRF, no hay configuración de IA, no existe resultado ligero útil y el render falla/no está disponible/no obtiene sesiones, o se exceden los 45 s. Nunca se incluyen detalles de red, proxy, Chromium o credenciales.
